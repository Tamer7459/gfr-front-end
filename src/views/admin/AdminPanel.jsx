...
const ROLE_OPTIONS = ['admin', 'researcher', 'professor', 'reviewer', 'user']
...
const AdminPanel = () => {
    ...
    const handleOpenRoleMenu = (event, user) => {
        ...
        <Box>
            ...
            >
                {ROLE_OPTIONS.map(role => (
                    <MenuItem
                        key={role}
                        selected={roleTargetUser?.role === role}
                        onClick={() =>
                            handleChangeRole(roleTargetUser.id, role)
                        }
                        disabled={roleTargetUser?.role === role}
                    >
