      ...
      <Card>
        <CardContent sx={{ p: 3 }}>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            {editing ? (
              <TextField fullWidth name="name" value={form.name} onChange={handleChange} size="small" dir={textDir} />
            ) : (
          ...
          <Box sx={{ mb: 3 }}>
            <Typography variant="subtitle2" fontWeight={600} mb={1}>
              <School fontSize="small" sx={{ mr: 0.5, verticalAlign: 'middle' }} />
              {t('profile.specialty')}
            </Typography>
            {editing ? (
              <TextField
              ...
              <Typography color="text.secondary">{user?.specialty || t('profile.notSetSpecialty')}</Typography>
            )}
          </Box>

          <Box sx={{ mb: 3 }}>
            <Typography variant="subtitle2" fontWeight={600} mb={1}>
              <Article fontSize="small" sx={{ mr: 0.5, verticalAlign: 'middle' }} />
              {t('profile.bio')}
            </Typography>
            {editing ? (
              <TextField
